...
function Homepage() {
  ...
  return (
    <div className="relative w-full h-screen bg-transparent" id="home">
      ...
      >
        {/* Light Porsche 911 GT3 RS Edge Runner driving along the BOTTOM border line of Navbar */}
        <div className="absolute -bottom-[20px] left-0 w-full h-10 pointer-events-none overflow-hidden rounded-b-full">
          <motion.div
            animate={{ x: ["-15%", "108%"] }}
          ...
          >
            <div className="relative flex items-center">
              ...
              <div className="w-10 h-[2px] bg-gradient-to-r from-transparent via-[#D5001C] to-[#FF334B] mr-0.5 shadow-[0_0_12px_#D5001C]" />

              {/* Light Porsche 911 GT3 RS Image */}
              <img 
                src="/porsche_gt3rs_side.png" 
                alt="Light Porsche 911 GT3 RS Side View" 
                className="w-20 sm:w-24 md:w-28 h-auto object-contain mix-blend-screen filter brightness-110 contrast-105 drop-shadow-[0_4px_16px_rgba(255,255,255,0.8)]" 
              />

              {/* LED Headlight Beam */}
              <div className="w-10 h-4 bg-gradient-to-r from-white/90 via-cyan-300/40 to-transparent -ml-3" />
            </div>
          </motion.div>
        </div>
